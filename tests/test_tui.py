...
def test_cursor_from_click_clamps_left_and_right():
    assert cursor_from_click(mouse_x=0, prompt_prefix_len=6, input_len=10) == 0
    assert cursor_from_click(mouse_x=20, prompt_prefix_len=6, input_len=5) == 5
